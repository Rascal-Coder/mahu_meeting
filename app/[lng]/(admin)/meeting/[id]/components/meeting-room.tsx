  ...
  return (
    <section className="relative w-full overflow-hidden text-white">
      <div className="relative flex size-full items-center justify-center">
        ...
        <div
          className={cn('shadow-lg bg-dark-2 px-8 pt-20 transition-all w-[320px] fixed  right-0 top-0 min-h-screen', showParticipants ? 'block' : 'hidden')}
        >
      ...
      <div className="flex w-full flex-wrap items-center gap-5 justify-center pt-20">
        ...
        <div className="flex gap-4">
          ...
          <button title='Share Link' onClick={() => setMeetingState('shareLink')}>
            <div className=" cursor-pointer rounded-2xl bg-[#19232d] px-4 py-2 hover:bg-[#4c535b]  ">
