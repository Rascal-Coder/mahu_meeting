...
export const AnimatedTooltip = ({
  ...
  return (
    <>
      {items.slice(0,4).map((item: any, idx: string) => (
        <div
        ...
        >
          ...
          <span     
            className="cursor-pointer flex items-center justify-center bg-dark-1 object-cover object-top rounded-full h-10 w-10 border-2 border-white relative transition duration-500"
